...
const HowToUse = () => {
  return (
    <section className="how-to-use-container">
      <h2 className="how-to-use-title">How Darsni AI Enhances Your Study Experience 🚀</h2>
      <p className="how-to-use-subtitle">
        Discover how Darsni uses AI to save you time, simplify learning, and make studying more efficient. 📚✨
      </p>
      <div className="steps-container">
        <div className="step-card">
          <h3>📤 Step 1: Upload Your Materials</h3>
          <p>
            Upload your notes, textbooks, or PDFs. Darsni's AI will analyze and organize them for you. 🗂️
          </p>
        </div>
        <div className="step-card">
